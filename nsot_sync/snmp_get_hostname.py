...
SNMP_MAPPER_BASE = {
    'arista_eos': {"oid": ".1.3.6.1.2.1.1.5.0",
                   "priority": 99},
    'cisco_ios': {"oid": ".1.3.6.1.2.1.1.5.0",
                  "priority": 60},
    'cisco_xe': {"oid": ".1.3.6.1.2.1.1.5.0",
                 "priority": 99},
    'cisco_asa': {"oid": ".1.3.6.1.2.1.1.5.0",
                  "priority": 99},
    'cisco_nxos': {"oid": ".1.3.6.1.2.1.1.5.0",
                   "priority": 99},
...
class SNMPHostnameDetect(object):
    """
    The SNMPHostnameDetect class tries to automatically determine the actual hostname of the device.
    ...
    def autodetect(self):
        """
        Try to get the hostname using SNMP GET.
        ...
        snmp_mapper_list = []
        for k, v in SNMP_MAPPER_BASE.items():
