...
import click
from ..drivers import ip_scanner
...
@click.option('--scan-all-update', is_flag=True, help='Will only change/add to all the networks scan attribute with set to true, wil not scan the networks.!!')
...
@click.pass_context
def cli(ctx, max_threads, scan_all, scan_all_update):
    """
